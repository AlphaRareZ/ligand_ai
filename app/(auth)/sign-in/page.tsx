        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-400">
              Access your research dashboard or <Link href="/sign-up" className="text-blue-500 hover:text-blue-400 font-medium transition-colors">Create a new account</Link>
            </p>
          </div>
