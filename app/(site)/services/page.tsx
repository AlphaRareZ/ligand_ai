                ...
                <div className="min-h-45 flex flex-col md:items-center md:flex-row p-6 bg-[#171e2d]/50 rounded-2xl gap-6">
                    <div className="flex flex-col gap-4">
                        ...
                        <p className="text-[#8e9cb1] font-semibold">
                            Our algorithms are trained on over 500TB of clinical
                            and molecular data, providing verified insights that
                            reduce lead optimization time by 65%.
                        </p>
                    </div>
...
function FeatureCard({
    ...
    return (
        <div
            style={
                { "--theme-color": COLORS[primaryColor] } as React.CSSProperties
            }
