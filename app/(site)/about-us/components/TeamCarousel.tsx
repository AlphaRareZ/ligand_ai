...
const TEAM: TeamMember[] = [
  {
    ...
    role: "Data Scientist",
    quote:
      "Bridging the gap between complex AI models and an intuitive user experience. I design the systems that turn raw molecular predictions into actionable clinical insights for researchers.",
    image: "/team1.png",
...

  {
    ...
    quote:
      "Designing molecules from first principles using generative neural networks. Our models learn the grammar of chemistry to propose ligands that are both novel and synthesisable.",
    image: "/team3.png",
  ...
  },
  {
    ...
    quote:
      "Applying multi-objective optimisation to the drug discovery pipeline. We're not just ranking candidates — we're providing decision frameworks that account for toxicity, cost, and synthesisability simultaneously.",
    image: "/team4.png",
  ...
  },
  {
    ...
    role: "Operations Research & Decision Support",
    quote:
      "As a computational biologist, I work on the front lines of precision medicine — translating complex genomic data into actionable therapeutic strategies. My research focuses on deciphering the transcriptomic signatures of AML to identify novel drug targets and predict treatment response.",
    image: "/team4.png",
    linkedin: "https://www.linkedin.com/",
    ...
    quote:
      "I build more than software — I build systems with intention.From architecture to deployment, every part of the project reflects problem solving, engineering, and countless hours of turning ideas into something real",
    image: "/me.png",
    linkedin: "https://www.linkedin.com/",
...
export default function TeamCarousel() {
  ...
  const slideOut = direction === "right" ? "-translate-x-8 opacity-0" : "translate-x-8 opacity-0";
      ...
      <div className="relative overflow-hidden rounded-2xl border border-white/[0.07] bg-white/[0.025] backdrop-blur-sm shadow-2xl">
        ...
        >
          ...
          <div className="flex flex-col justify-between p-8 lg:p-12 order-2 lg:order-1">
            {/* Quote */}
            <div className="mb-8">
              <span className="text-5xl font-serif text-[#1152d4]/40 leading-none select-none">&ldquo;</span>
            ...
            <div className="flex items-end justify-between gap-4">
              <div>
                ...
                <p className="text-[#1152d4] text-sm font-semibold mt-0.5">{member.role}</p>
              </div>
